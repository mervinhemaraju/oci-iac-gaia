...
resource "oci_identity_policy" "zeus_cross_conection_statements" {
  ...
  statements = [
    ...
    "admit group ${local.values.groups.zeus_groups.vcn_admins.name} of tenancy zeusTenancy to manage local-peering-to in tenancy",
    ...
    "admit group ${local.values.groups.zeus_groups.vcn_admins.name} of tenancy zeusTenancy to associate local-peering-gateways in tenancy zeusTenancy with local-peering-gateways in tenancy"
  ]
